...
Developer-friendly & type-safe Typescript SDK specifically catered to leverage *meepy-moopy* API.

<div align="left">
    <a href="https://www.speakeasy.com/?utm_source=meepy-moopy&utm_campaign=typescript"><img src="https://custom-icon-badges.demolab.com/badge/-Built%20By%20Speakeasy-212015?style=for-the-badge&logoColor=FBE331&logo=speakeasy&labelColor=545454" /></a>
...
```bash
npm add https://github.com/kanwardeep007/meepy-moopy
```

### PNPM

```bash
pnpm add https://github.com/kanwardeep007/meepy-moopy
```

### Bun

```bash
bun add https://github.com/kanwardeep007/meepy-moopy
```
...
```typescript
import { Petstore } from "meepy-moopy";
import * as errors from "meepy-moopy/models/errors";
...
### SDK Created by [Speakeasy](https://www.speakeasy.com/?utm_source=meepy-moopy&utm_campaign=typescript)
